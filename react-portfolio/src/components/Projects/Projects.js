    ...
    <div className="container">
      <div className="row">
        <div className="col l6">
          ...
          <img
            ...
            src="https://github.com/Jorgelopez5252/port2023/blob/master/react-portfolio/public/images/city2citygif.gif?raw=true"
            alt="mock"
          />
        </div>
      ...
      <div className="row">
        <div className="col l6">
          ...
          <img
            className="projectImage"
            src="https://github.com/Jorgelopez5252/port2023/blob/master/react-portfolio/public/images/tempusgif.gif?raw=true"
            alt="mock"
          />
        </div>
      ...
      <div className="row">
        <div className="col l6">
          ...
          <img
            className="projectImage"
            src="https://github.com/Jorgelopez5252/port2023/blob/master/react-portfolio/public/images/notetakergif.gif?raw=true"
            alt="mock"
          />
        </div>
